...
def split_data(edge_list):
	...
	test_indexes = set(random.sample(indexes, int(len(indexes)/1.1))) # removing 50% edges from test data
...
def main():
	...
	edge_list = get_edge_list("edge_list_unweighted.txt")

	local_methods(edge_list,"preferential_attachment")
	#katz(edge_list)
	#friendtns(edge_list,"friendtns")
